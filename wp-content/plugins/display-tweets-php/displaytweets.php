...
class DisplayTweets {
    ...
    public function format_tweet( $text ) {
        ...
        $text = preg_replace( "/@(\w+)/", "<p class='resenas'><b> <a href=\"http://www.twitter.com/\\1\" target=\"_blank\">@\\1</a></b></p>", $text );
        $text= str_replace(":", '', $text);
        $text = preg_replace( "/#(\w+)/", "<a href=\"http://twitter.com/search?q=%23\\1&src=hash\" target=\"_blank\">#\\1</a>", $text );
        $contenido ="<div class='post hentry ivycat-post'> 
		           <div class='entry-summary'>
		             <blockquote class='alignleft'>$text</blockquote>
		            </div>    
		         </div>
		         <div class='clear'></div>
